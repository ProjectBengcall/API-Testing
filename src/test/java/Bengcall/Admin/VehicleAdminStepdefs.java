...
public class VehicleAdminStepdefs {
    ...
    public void sendRequestViewAllVehicleTypeOnAdmin() {
        SerenityRest.when().get(BengcallAdminAPI.GET_ALL_VEHICLE_ADMIN);}


    @And("View all vehicle type on admin assert json validation")
    public void viewAllVehicleTypeOnAdminAssertJsonValidation() {
        File jsonFile = new File(BengcallAdminAPI.JSON_FILE+"/JsonSchemaValidation/Admin/Vehicle/GetAdminAllVehicleJsonSchemaValidation.json");
        SerenityRest.then()
                .assertThat()
    ...
    public void sendRequestViewAllVehicleTypeOnAdminInvalidPath() {
        SerenityRest.when().get(BengcallAdminAPI.GET_ALL_VEHICLE_ADMIN_INVALID_PATH);}
    ...
    public void viewAllVehicleTypeOnAdminWithInvalidPathAssertJsonValidation() {
        File jsonFile = new File(BengcallAdminAPI.JSON_FILE+"/JsonSchemaValidation/Admin/Vehicle/GetAdminAllVehicleInvalidJsonSchemaValidation.json");
        SerenityRest.then()
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchema(jsonFile));}
    ...
    public void setCreateVehicleTypeOnAdminRequestData() {
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Vehicle/PostAdminCreateNewVehicle.json");
    ...
    public void sendRequestCreateNewVehicleTypeOnAdmin() {
        SerenityRest.when().post(BengcallAdminAPI.POST_CREATE_VEHICLE_ADMIN);}
    ...
    public void postCreateNewVehicleOnAdminWithValidDataAssertJsonValidation() {
        File jsonFile = new File(BengcallAdminAPI.JSON_FILE+"/JsonSchemaValidation/Admin/Vehicle/PostAdminCreateNewVehicleJsonSchemaValidation.json");
        SerenityRest.then()
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchema(jsonFile));}
    ...
    public void setCreateVehicleTypeOnAdminEmptyValueRequestData() {
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Vehicle/PostAdminCreateNewVehicleEmptyValue.json");
        bengcallAdminAPI.postCreateNewVehicleOnAdminWithToken(jsonFiles);}

    @And("Post create new vehicle with on admin with invalid data assert json validation")
    public void postCreateNewVehicleWithOnAdminWithInvalidDataAssertJsonValidation() {File jsonFile = new File(BengcallAdminAPI.JSON_FILE+"/JsonSchemaValidation/Admin/Vehicle/PostAdminCreateNewVehicleInvalidJsonSchemaValidation.json");
        SerenityRest.then()
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchema(jsonFile));}
    ...
    public void setCreateVehicleTypeOnAdminSpecialCharacterValueRequestData() {
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Vehicle/PostAdminCreateNewVehicleSpecCharacter.json");
        bengcallAdminAPI.postCreateNewVehicleOnAdminWithToken(jsonFiles);}
    ...
    public void sendDeleteNewVehicleTypeOnAdmin() {
        SerenityRest.when().delete(BengcallAdminAPI.DELETE_VEHICLE_TYPE_ADMIN);}

    @And("Delete vehicle type on admin assert json validation")
    public void deleteVehicleTypeOnAdminAssertJsonValidation() {
        File jsonFile = new File(BengcallAdminAPI.JSON_FILE+"/JsonSchemaValidation/Admin/Vehicle/PostAdminCreateNewVehicleInvalidJsonSchemaValidation.json");
        SerenityRest.then()
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchema(jsonFile));}
    ...
    public void sendDeleteNewVehicleTypeOnAdminWithoutId() {
        SerenityRest.when().delete(BengcallAdminAPI.DELETE_VEHICLE_TYPE_ADMIN_NO_ID);}
    ...
    public void sendDeleteNewVehicleTypeOnAdminWithSpecialCharacter() {
        SerenityRest.when().delete(BengcallAdminAPI.DELETE_VEHICLE_TYPE_ADMIN_SPEC_CHARACTER);}
}
