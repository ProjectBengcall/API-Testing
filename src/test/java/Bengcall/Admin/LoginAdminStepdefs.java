...
public class LoginAdminStepdefs {
    ...
    public void adminLoginWithValidRequestData (){
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Login/PostAdminLoginCustomer.json");
    ...
    public void postAdminLoginValidCredentialsAssertJsonValidation(){
        File jsonFile = new File(BengcallAdminAPI.JSON_FILE+"/JsonSchemaValidation/Admin/Login/PostAdminLoginJsonSchemaValidation.json");
        SerenityRest.then()
                .assertThat()
    ...
    public void adminLoginWithInvalidRequestData(){
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Login/PostAdminLoginUnregistered.json");
        bengcallAdminAPI.postLoginAdmin (jsonFiles);}
    ...
    public void postAdminLoginInvalidCredentialsAssertJsonValidation(){
        File jsonFile = new File(BengcallAdminAPI.JSON_FILE+"/JsonSchemaValidation/Admin/Login/PostAdminLoginInvalidJsonSchemaValidation.json");
        SerenityRest.then()
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchema(jsonFile));}
    ...
    public void adminLoginWithEmptyEmailValue(){
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Login/PostAdminLoginEmptyEmail.json");
        bengcallAdminAPI.postLoginAdmin (jsonFiles);}
    ...
    public void adminLoginWithEmptyPasswordValue(){
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Login/PostAdminLoginEmptyPassword.json");
        bengcallAdminAPI.postLoginAdmin (jsonFiles);}

    @Given("Admin login with special character")
    public void adminLoginWithSpecialCharacter() {
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Login/PostAdminLoginSpecialChar.json");
        bengcallAdminAPI.postLoginAdmin (jsonFiles);}

    @Given("Admin login with empty email and password value")
    public void adminLoginWithEmptyEmailAndPasswordValue() {
        File jsonFiles = new File(BengcallAdminAPI.JSON_FILE+"/JsonRequestBody/Admin/Login/PostAdminLoginEmptyEmailAndPassword.json");
        bengcallAdminAPI.postLoginAdmin (jsonFiles);}

    @And("Post admin login response should contain {}")
    public void postAdminLoginResponseShouldContain(String message) {
        SerenityRest.then()
